<template>
  <div>
    ...
    <!-- 分配角色对话框区域 -->
    <el-dialog title="分配角色" :visible.sync="allocateDialogVisible" width="50%" @close="allocateDialogClosed">
      <div>
...
export default {
  ...
  methods: {
    ...
    // 点击“分配角色”按钮触发的事件
    async openAllocateRoleDialog (userInfo) {
